  ...
  return (
    <div className="max-w-[1200px] mx-auto py-10 px-4">
      ...
      <nav className="flex gap-6 mb-8 border-b pb-2 text-sm">
        ...
        <Link href="/team_management/my_recruit" className="text-gray-600 hover:text-black">
          나의 모집
        </Link>

        <Link href="/team_management/my_apply" className="text-gray-600 hover:text-black">
          나의 지원
        </Link>
      </nav>
