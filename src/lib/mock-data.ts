  ...
  teams: [
    {
      ...
      teamName: 'AI 데이터 분석팀',
      description:
        '데이터 분석과 AI 기술에 관심있는 분들 모집합니다! 도서관 서비스 혁신 아이디어로 참여할 예정입니다.',
      leaderName: '김도서',
    ...
    },
    {
      ...
      currentMembers: 3,
      maxMembers: 5,
      requiredPositions: [{ role: '데이터사이언티스트', count: 2, currentCount: 0 }],
    ...
    },
    {
      ...
      currentMembers: 3,
      maxMembers: 5,
      requiredPositions: [{ role: '풀스택', count: 2, currentCount: 0 }],
      tags: ['빠른개발', '효율적', '다재다능'],
      status: 'recruiting',
